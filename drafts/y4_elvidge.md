...
**When:** today / Day 1 (2026-05-06 or 05-07)
**Why this matters:** Elvidge is the author of every methodology pyflare cites. A 2-3 sentence quoted endorsement from him is the single highest-credibility signal we can attach to the project. Top-7 critical-path item.

---

## Suggested subject

> pyflare — Python toolkit implementing your VNF methodology, requesting endorsement
...
>
> Optional second ask, with a clear path: if the EOG project page or wiki could link to pyflare as a third-party Python interface, that would close a real gap for African researchers. I understand that requires written permission from EOG/Mines; I'm happy to make that request through `eog@mines.edu` if you're open in principle.
>
> Happy to share the test suite (41 tests passing, no network in CI) or walk through the code on a 20-min call. The poster proposal goes to PyCon Africa on 2026-05-20.
>
> With genuine thanks for keeping VNF in the open,
>
> Johnpaul Okeke
> University of Lagos
...
- ✗ "delve", "tapestry", "leverage" (verb), "furthermore"
- ✗ Three em-dashes in one paragraph
- ✗ "I hope this finds you well" — flags as cold-LLM-spam
- ✓ Add one specific detail only you would know — e.g. *"The first time I ran your 2016 regression on Niger Delta data and saw the numbers tally with what NOSDRA reports independently, the value of an open implementation became impossible to ignore."*
...
- Note send time in [STATUS.md](../STATUS.md) Y4a row
- Polite ping at Day 4 (2026-05-10) if no reply
- Day 7 silence → SDN/Adeyanju become the primary endorsements; Elvidge remains a stretch goal
